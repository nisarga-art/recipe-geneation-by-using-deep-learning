const recipes = [
  ...
  ,
  {
    ...
    pantryMatch: 70,
    ingredients: { available: ["Chicken", "Tomato", "Butter", "Cream"], missing: ["Fenugreek"] },
    nutrition: { protein: 28, carbs: 20, fat: 34, fiber: 2 },
    healthBenefits: ["High protein", "Iron rich"],
    steps: ["Marinate chicken in yogurt and spices","Cook tomato-onion gravy","Add butter and cream","Add chicken and simmer"],
  ...
  },
  {
    ...
    pantryMatch: 65,
    ingredients: { available: ["Chicken", "Yogurt", "Spices"], missing: ["Red chili powder"] },
    nutrition: { protein: 34, carbs: 6, fat: 26, fiber: 1 },
    healthBenefits: ["High protein"],
    steps: ["Marinate chicken in yogurt and spices","Grill or bake until charred and cooked through"],
  ...
  },
  {
    ...
    pantryMatch: 75,
    ingredients: { available: ["Potato", "Peas", "Flour"], missing: ["Spices"] },
    nutrition: { protein: 5, carbs: 30, fat: 12, fiber: 3 },
    healthBenefits: ["Energy rich"],
    steps: ["Make dough","Prepare spiced potato filling","Fill and shape samosas","Deep fry until golden"],
  ...
  },
  {
    ...
    pantryMatch: 88,
    ingredients: { available: ["Potato", "Cauliflower", "Tomato", "Spices"], missing: [] },
    nutrition: { protein: 6, carbs: 35, fat: 6, fiber: 5 },
    healthBenefits: ["High fiber", "Low fat"],
    steps: ["Chop vegetables","Cook spices and tomatoes","Add vegetables and simmer until tender"],
  ...
  },
  {
    ...
    pantryMatch: 70,
    ingredients: { available: ["Potato", "Tomato", "Bread Rolls"], missing: ["Butter"] },
    nutrition: { protein: 8, carbs: 58, fat: 14, fiber: 7 },
    healthBenefits: ["Filling meal"],
    steps: ["Boil and mash vegetables","Cook bhaji with spices","Serve with buttered pav"],
  ...
  },
  {
    ...
    difficulty: "Medium",
    meal: "Lunch",
    image: "https://source.unsplash.com/600x400/?prawn,curry,shrimp",
    pantryMatch: 66,
    ingredients: { available: ["Prawns", "Coconut Milk", "Spices"], missing: [] },
    nutrition: { protein: 25, carbs: 10, fat: 22, fiber: 1 },
    healthBenefits: ["High protein", "Low carb"],
    steps: ["Saute onions and spices","Add prawns and cook","Stir in coconut milk and simmer briefly"],
  ...
  },
  {
    ...
    difficulty: "Medium",
    meal: "Lunch",
    image: "https://source.unsplash.com/600x400/?fish,curry,seafood",
    pantryMatch: 68,
    ingredients: { available: ["Fish", "Tamarind", "Spices"], missing: [] },
    nutrition: { protein: 30, carbs: 8, fat: 20, fiber: 1 },
    healthBenefits: ["Omega-3", "High protein"],
    steps: ["Prepare tangy tamarind-spice base","Add fish pieces and simmer until cooked"],
  ...
  },
  {
    ...
    pantryMatch: 85,
    ingredients: { available: ["Dark Chocolate", "Butter", "Eggs", "Flour"], missing: [] },
    nutrition: { protein: 6, carbs: 50, fat: 22, fiber: 3 },
    healthBenefits: ["Mood booster"],
    steps: ["Melt chocolate and butter","Mix with eggs and sugar","Fold in flour and bake"],
  ...
  },
  {
    ...
    difficulty: "Easy",
    meal: "Breakfast",
    image: "https://source.unsplash.com/600x400/?pancakes,syrup,breakfast",
    pantryMatch: 90,
    ingredients: { available: ["Flour", "Milk", "Eggs", "Baking Powder"], missing: [] },
    nutrition: { protein: 8, carbs: 45, fat: 10, fiber: 1 },
    healthBenefits: ["Quick energy"],
    steps: ["Mix batter","Cook on a hot griddle until golden","Serve with syrup and fruit"],
  ...
  },
  {
    ...
    pantryMatch: 78,
    ingredients: { available: ["Tomato", "Eggs", "Onion", "Spices"], missing: [] },
    nutrition: { protein: 12, carbs: 28, fat: 16, fiber: 5 },
    healthBenefits: ["High protein", "Vitamin rich"],
    steps: ["Cook spiced tomato sauce","Crack eggs and cook until set","Serve with bread"],
  ...
  },
  {
    ...
    difficulty: "Easy",
    meal: "Lunch",
    image: "https://source.unsplash.com/600x400/?tofu,stir-fry,vegetables",
    pantryMatch: 82,
    ingredients: { available: ["Tofu", "Broccoli", "Soy Sauce", "Garlic"], missing: [] },
    nutrition: { protein: 18, carbs: 20, fat: 12, fiber: 4 },
    healthBenefits: ["Plant protein", "Low calorie"],
    steps: ["Press and cube tofu","Stir fry tofu until golden","Add vegetables and sauce and toss"],
  ...
  },
  {
    ...
    difficulty: "Medium",
    meal: "Dinner",
    image: "https://source.unsplash.com/600x400/?ramen,noodles,soup",
    pantryMatch: 60,
    ingredients: { available: ["Noodles", "Broth", "Pork", "Egg"], missing: [] },
    nutrition: { protein: 30, carbs: 60, fat: 18, fiber: 3 },
    healthBenefits: ["Comforting", "Protein rich"],
    steps: ["Prepare rich broth","Cook noodles and toppings","Assemble bowl and serve hot"],
